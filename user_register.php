...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>register now</h3>
      <input type="text" name="name" required placeholder="Username" maxlength="20"  class="form-control">
      ...
      <input type="password" name="cpass" required placeholder="Re-enter password" maxlength="20"  class="form-control" oninput="this.value = this.value.replace(/\s/g, '')">
