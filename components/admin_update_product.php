                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Description</label>
                                        <input type="text" class="form-control" value="<?= $fetch_products['details']; ?>"
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="image_03" class="custom-file-input" id="image-3" required>
                                ...
                                <a href="products.php" type="submit" name="add_product"
